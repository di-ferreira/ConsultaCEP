...
type
  ...
  public
    ...
    property Simutaneios: Integer read FSimutaneios write FSimutaneios default 1;
    ...
    property ConversaAtual:TBotConversa read FConversaAtual write FConversaAtual;
